-- *************************************************************
-- This script creates a slightly modified version of the 
-- AP (Accounts Payable) database for Murach's MySQL by 
-- Joel Murach, ported from MySQL to SQL Server's T-SQL 
-- *************************************************************
...
(
  ...
  vendor_name                   VARCHAR(256)    NOT NULL      UNIQUE,
  vendor_address1               VARCHAR(128),
  vendor_address2               VARCHAR(128),
  vendor_city                   VARCHAR(64)    NOT NULL,
  vendor_state                  CHAR(2)        NOT NULL,
  vendor_zip_code               VARCHAR(20)    NOT NULL,
  vendor_phone                  VARCHAR(50),
  vendor_contact_last_name      VARCHAR(128),
  vendor_contact_first_name     VARCHAR(128),
  vendor_contact_email          VARCHAR(128),
...
INSERT INTO vendors(vendor_id, vendor_name, vendor_address1, vendor_address2, vendor_city, vendor_state, vendor_zip_code, vendor_phone, vendor_contact_last_name, vendor_contact_first_name, default_terms_id, default_account_number) VALUES 
...
INSERT INTO invoices(invoice_id, vendor_id, invoice_number, invoice_date, invoice_total, payment_total, credit_total, terms_id, invoice_due_date, payment_date) VALUES
...
(4,1,553,'144.70','International shipment'),
...
(76,1,553,'241.00','International shipment'),
...
(85,1,553,'158.00','International shipment'),
