...
{
    public class PYAlbumController : Controller
    {
        private readonly MvcMusicStoreContext _context;

        public PYAlbumController(MvcMusicStoreContext context)
        {
            _context = context;
        }
