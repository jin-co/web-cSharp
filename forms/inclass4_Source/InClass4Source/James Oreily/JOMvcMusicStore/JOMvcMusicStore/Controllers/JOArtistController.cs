...
{
    public class JOArtistController : Controller
    {
        private readonly MvcMusicStoreContext _context;

        public JOArtistController(MvcMusicStoreContext context)
        {
            _context = context;
        }
