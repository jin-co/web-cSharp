...
using JKMusicStore.Models;

namespace JKMusicStore.Controllers
{
    public class JKAlbumsController : Controller
    {
        private readonly MvcMusicStoreContext _context;

        public JKAlbumsController(MvcMusicStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var mvcMusicStoreContext = _context.Albums.Include(a => a.Artist).Include(a => a.Genre);
            return View(await mvcMusicStoreContext.ToListAsync());
        }

        // GET: JKAlbums/Details/5
